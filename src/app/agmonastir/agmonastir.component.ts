...
@Component({
  selector: 'app-agmonastir',
  templateUrl: './agmonastir.component.html',
  styleUrl: './agmonastir.component.css'
})
export class AgmonastirComponent {
  employes: any[] = [];
  ...
  hasMatchingEmploye(agence: string): boolean {
    return this.employes.some(
      employe => employe.agence == agence && employe.direction == 'monastir' && employe.siege == false
    );
  }
